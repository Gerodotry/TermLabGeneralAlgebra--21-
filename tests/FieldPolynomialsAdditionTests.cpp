...
#ifdef FIELD_POLYNOMIAL_ADDITION_UNIT_TESTS
...
TEST_CASE("Polynomial addition test 2") {
...
TEST_CASE("Polynomial addition test 3") {
    FieldPolynomial polynomial1 = { {4, 0}, {3, 1}, {2, 0}, {1, 1}, {0, 0} };
    FieldPolynomial polynomial2 = { {3, 1}, {2, 0}, {1, 1}, {0, 1} };

    FieldPolynomial result = PolynomialAddition::run(polynomial1, polynomial2, 3);
    FieldPolynomial expected = { {3, 2}, {1, 2}, {0, 1} };

    CHECK(expected.toString() == result.toString());
}

TEST_CASE("Polynomial addition test 4") {
    FieldPolynomial polynomial1 = { {5, 0}, {4, 1}, {3, 0}, {2, 0}, {1, 1}, {0, 1} };
    FieldPolynomial polynomial2 = { {4, 0}, {3, 1}, {2, 0}, {1, 1}, {0, 0} };

    FieldPolynomial result = PolynomialAddition::run(polynomial1, polynomial2, 2);
