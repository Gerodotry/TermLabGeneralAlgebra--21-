...
// Standard Drag and Drop payload types. You can define you own payload types using short strings. inputComponents starting with '_' are defined by Dear ImGui.
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_Uint8           = 1 << 23,  // [inputComponents]   // ColorEdit, ColorPicker, ColorButton: _display_ values formatted as 0..255.
    ImGuiColorEditFlags_Float           = 1 << 24,  // [inputComponents]   // ColorEdit, ColorPicker, ColorButton: _display_ values formatted as 0.0f..1.0f floats instead of 0..255 integers. No round-trip of value via integers.
...
// inputComponents are NOT stored, so it is up to you to make sure your Key don't collide with different types.
struct ImGuiStorage
{
    // [Internal]
