...
static void ShowDemoWindowWidgets()
{
    ...
    IMGUI_DEMO_MARKER("Widgets/Data inputComponents");
    if (ImGui::TreeNode("Data inputComponents"))
    {
        ...
        IMGUI_DEMO_MARKER("Widgets/Data inputComponents/Drags");
        ImGui::SeparatorText("Drags");
        ...
        IMGUI_DEMO_MARKER("Widgets/Data inputComponents/Sliders");
        ImGui::SeparatorText("Sliders");
        ...
        IMGUI_DEMO_MARKER("Widgets/Data inputComponents/Inputs");
