...
// Read code of e.g. DragFloat(), DragInt() etc. or examples in 'Demo->Widgets->Data inputComponents' to understand how to use this function directly.
...
// Read code of e.g. SliderFloat(), SliderInt() etc. or examples in 'Demo->Widgets->Data inputComponents' to understand how to use this function directly.
...
// Read code of e.g. InputFloat(), InputInt() etc. or examples in 'Demo->Widgets->Data inputComponents' to understand how to use this function directly.
